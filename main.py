#Token: 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
"""For creating Windows executable:
1) Open command prompt
2) Write the command: pip install pyinstaller
3) Write the command: cd location_of_Python_script
4) Write the command: pyinstaller --onefile pythonScriptName.py
"""
...
answer = input("This file analyzes all sound recordings in this directory. Do you want to continue?\nY/N\n")
    ...
    for file in dir_list:
        ...
        if write_switch: 
            ...
            with open(FILE_NAME, "a", newline='') as csv_file:
                ...
                csv_file.close()  
    print("Data are ready in the data.csv file.")        
    #plt.show()
